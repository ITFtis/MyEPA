...
INSERT [dbo].[DisinfectantType] ([Id], [Type], [Name]) VALUES (1, N'A01', N'環境用藥(固態Kg)')
INSERT [dbo].[DisinfectantType] ([Id], [Type], [Name]) VALUES (2, N'A02', N'環境用藥(液態L)')
INSERT [dbo].[DisinfectantType] ([Id], [Type], [Name]) VALUES (3, N'A03', N'登革熱用藥(固態Kg)')
INSERT [dbo].[DisinfectantType] ([Id], [Type], [Name]) VALUES (4, N'A04', N'登革熱用藥(液態L)')
