...
namespace EPASchedule
{
    internal class DateFormat
    {
        ...
        /// <summary>
        /// 西元轉民國：2023-12-20 00:00:00.000 => 112年3月5日 星期日
        /// </summary>
        /// <param name="date"></param>
        /// <returns></returns>
        ...
        /// <param name="date"></param>
        /// <returns></returns>
        public static string ToTwDate6(string date)
        {
            string result = "";
        ...
        /// <param name="date"></param>
        /// <returns></returns>
        public static string ToTwDate6(DateTime date)
        {
            string result = "";
        ...
        public static string ToTime2(string str)
        {
            ...
            try
            {
                ...
                {
                    result = str.Substring(0, str.Length - 2) + ":" + str.Right(2);
                }
                else
                {
                    result = str;
        ...
        public static string ToWeekName(DateTime date)
        {
            string str = "";
